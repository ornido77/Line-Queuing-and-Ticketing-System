...
"}")
        ...
        self.frame_leftBody.setMaximumSize(QtCore.QSize(550, 16777215))
...
"border-radius: 10px;")
        ...
        self.label_compName.setMaximumSize(QtCore.QSize(450, 100))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.label_compName.setFont(font)
        self.label_compName.setStyleSheet("background-image: url(:/newPrefix/Pictures/img/01.jpg);\n"
"border-radius: 20px;")
        self.label_compName.setText("")
        self.label_compName.setTextFormat(QtCore.Qt.RichText)
        self.label_compName.setPixmap(QtGui.QPixmap(":/newPrefix/Pictures/img/01.jpg"))
