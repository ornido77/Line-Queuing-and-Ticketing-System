...
"}")
        ...
        self.frame_contentBar_layout.setContentsMargins(0, 0, 10, 0)
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.frame_leftBody)
...
"border-radius: 10px;")
        ...
        self.label_ticketValue1.setStyleSheet("color: rgb(255, 255, 0);")
...
"color: rgb(255, 255, 127);")
        ...
        self.verticalLayout.addWidget(self.frame_service1)
...
"border-radius: 10px;")
        ...
        self.label_ticketValue2.setStyleSheet("color: rgb(255, 255, 0);")
...
"color: rgb(255, 255, 127);")
        ...
        self.verticalLayout.addWidget(self.frame_service2)
...
"border-radius: 10px;")
        ...
        self.label_ticketValue3.setStyleSheet("color: rgb(255, 255, 0);")
...
"color: rgb(255, 255, 127);")
        ...
        self.verticalLayout.addWidget(self.frame_service3)
        self.frame_service4 = QtWidgets.QFrame(self.frame_leftBody)
        self.frame_service4.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.557, y1:0, x2:0.539773, y2:0.642, stop:0 rgba(255, 0, 0, 255), stop:1 rgba(255, 112, 112, 255));\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;")
        self.frame_service4.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_service4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_service4.setObjectName("frame_service4")
        self.frame_service1_layout_2 = QtWidgets.QVBoxLayout(self.frame_service4)
        self.frame_service1_layout_2.setContentsMargins(0, 0, 0, 0)
        self.frame_service1_layout_2.setSpacing(0)
        self.frame_service1_layout_2.setObjectName("frame_service1_layout_2")
        self.frame_ticket4 = QtWidgets.QFrame(self.frame_service4)
        self.frame_ticket4.setStyleSheet("background: none;")
        self.frame_ticket4.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_ticket4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_ticket4.setObjectName("frame_ticket4")
        self.frame_ticket1_layout_3 = QtWidgets.QHBoxLayout(self.frame_ticket4)
        self.frame_ticket1_layout_3.setContentsMargins(0, 0, 0, 0)
        self.frame_ticket1_layout_3.setSpacing(0)
        self.frame_ticket1_layout_3.setObjectName("frame_ticket1_layout_3")
        self.label_ticketNo4 = QtWidgets.QLabel(self.frame_ticket4)
        font = QtGui.QFont()
        font.setPointSize(36)
        self.label_ticketNo4.setFont(font)
        self.label_ticketNo4.setIndent(20)
        self.label_ticketNo4.setObjectName("label_ticketNo4")
        self.frame_ticket1_layout_3.addWidget(self.label_ticketNo4)
        self.label_ticketValue4 = QtWidgets.QLabel(self.frame_ticket4)
        font = QtGui.QFont()
        font.setPointSize(48)
        self.label_ticketValue4.setFont(font)
        self.label_ticketValue4.setAutoFillBackground(False)
        self.label_ticketValue4.setStyleSheet("color: rgb(0, 255, 0);")
        self.label_ticketValue4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_ticketValue4.setIndent(20)
        self.label_ticketValue4.setObjectName("label_ticketValue4")
        self.frame_ticket1_layout_3.addWidget(self.label_ticketValue4)
        self.frame_service1_layout_2.addWidget(self.frame_ticket4)
        self.label_room4 = QtWidgets.QLabel(self.frame_service4)
        font = QtGui.QFont()
        font.setPointSize(36)
        self.label_room4.setFont(font)
        self.label_room4.setStyleSheet("background: none;\n"
"color: rgb(0, 255, 0);")
        self.label_room4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_room4.setObjectName("label_room4")
        self.frame_service1_layout_2.addWidget(self.label_room4)
        self.verticalLayout.addWidget(self.frame_service4)
        self.frame_contentBar_layout.addWidget(self.frame_leftBody)
        self.frame_rightBody = QtWidgets.QFrame(self.frame_content_bar)
        self.frame_rightBody.setStyleSheet("border-radius: 10px;")
        ...
        self.label_compName.setMinimumSize(QtCore.QSize(300, 150))
        self.label_compName.setMaximumSize(QtCore.QSize(500, 180))
        font = QtGui.QFont()
...
"background-image: url(:/newPrefix/01.png);")
        self.label_compName.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_compName.setFrameShadow(QtWidgets.QFrame.Raised)
...
"background-color:none")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ticketValue1.setText(_translate("MainWindow", "0"))
        self.label_room1.setText(_translate("MainWindow", "Room 101"))
        self.label_ticketNo2.setText(_translate("MainWindow", "Ticket No."))
        self.label_ticketValue2.setText(_translate("MainWindow", "0"))
        self.label_room2.setText(_translate("MainWindow", "Room 102"))
        self.label_ticketNo3.setText(_translate("MainWindow", "Ticket No."))
        self.label_ticketValue3.setText(_translate("MainWindow", "0"))
        self.label_room3.setText(_translate("MainWindow", "Room 103"))
        self.label_ticketNo4.setText(_translate("MainWindow", "Ticket No."))
        self.label_ticketValue4.setText(_translate("MainWindow", "0"))
        self.label_room4.setText(_translate("MainWindow", "PRIORITY"))
        self.label_ticket.setText(_translate("MainWindow", "Ticket Number"))
        self.label_ticketValue.setText(_translate("MainWindow", "---"))
